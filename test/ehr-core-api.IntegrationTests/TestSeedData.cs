...
public class TestSeedData
{
                    ...
                    List<Appointment> appointments) SeedTestData(ApiDbContext _db)
    {
            ...
            var appointments = new List<Appointment>
            {
                ...
                new Appointment { Patient = patients[0], Clinician = clinicians[3], Department = "Pharmacology",     Status = AppointmentStatus.Completed, AppointmentTime = new DateTime(2026, 6, 18, 11, 15, 0) }
