...
public class TestSeedData
{
                    ...
                    List<Appointment> appointments) SeedTestData(ApiDbContext _db)
    {
            ...
            _db.Clinicians.AddRange(clinicians);
            ...
            _db.SaveChanges(); // patients and clinicians now have DB-assigned ids
            ...
            var appointments = new List<Appointment>
            {
                ...
                new Appointment { Patient = patients[2], Clinician = clinicians[3], Department = "Pharmacology",     Status = AppointmentStatus.Completed, AppointmentTime = new DateTime(2026, 6, 18, 11, 15, 0) }
    ...
    return (patients, clinicians, appointments);
    }
}